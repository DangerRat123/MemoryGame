...
async function startLocation(loc) {
  try {
    ...
    // any location's final node can just point at "ending-1". This is
    // optional: if it hasn't been added to the repo yet, the location
    // still plays fine, it just won't have anywhere to go after its
    // current final node until the ending file exists.
    try {
